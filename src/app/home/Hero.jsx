  ...
  return (
    <section className="bg-[#E6F8F3] min-h-[87vh] flex items-center pt-20 pb-8 md:pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto w-full">
        ...
        {/* more gap + flexible sides */}
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between
          gap-10 md:gap-16 lg:gap-32 xl:gap-40">
          ...
          <div className="flex-1 shrink-0 text-center lg:text-left">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-4 md:mb-6">
              ...
              <span className="inline-block min-w-[200px] sm:min-w-[260px] md:min-w-[340px] lg:min-w-[550px]">
                <TypeAnimation
                  sequence={[
                    'Following Up',
                    2000,
         ...
         {/* RIGHT Section — now flexible */}
<div className="flex-1">
  <div className="relative">
    <Image
      src={HeroImage}
      alt="AI-powered lead management dashboard with Leadly robot assistant"
      className="rounded-2xl w-[110%] max-w-none h-auto"
      width={1050}   // increased intrinsic width
      height={750}   // increased intrinsic height
      priority
    />
  </div>
</div>
