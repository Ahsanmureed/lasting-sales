...
He introduced Pakistan's first Cloud Contact Center, scaling from zero to 7 million calls monthly and supporting 4,500+ SMEs. His solutions are trusted by banks, online stores, and hospitals nationwide.
                ...
                <div className="flex gap-3 mt-4">
                  ...
                  {/* YouTube Logo */}
                  <div className="w-8 h-8 bg-red-600 rounded flex items-center justify-center hover:bg-red-700 transition-colors cursor-pointer">
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                    </svg>
                  </div>
                </div>
                <button className="mt-6 bg-teal-600 text-white px-6 py-2 rounded-lg hover:bg-teal-700 transition-colors">
                  Book Call
                </button>
              </div>
