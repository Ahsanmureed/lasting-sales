      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-start space-x-3">
                ...
                <span>Castlegate Park, Birmingham Rd, Dudley DY1 4TB United Kingdom.</span>
              </div>
            </div>
            ...
            <div className="mt-6">
              <a 
                ...
                className="inline-block bg-teal-600 hover:bg-teal-700 text-white px-6 py-2 rounded-md text-sm font-medium transition-colors"
              >
                Book a Call
              </a>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li>
                <Link href="https://www.youtube.com/@lastingsales" className="hover:text-teal-600 transition-colors">
